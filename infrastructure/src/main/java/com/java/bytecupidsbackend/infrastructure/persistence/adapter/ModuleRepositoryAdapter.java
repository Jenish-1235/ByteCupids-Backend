...
public class ModuleRepositoryAdapter implements ModuleRepository {
    ...
    public List<Module> getAllModules(){
        ...
        for(ModuleEntity moduleEntity : moduleEntities){
            modules.add(new Module(moduleEntity.getModuleId() , moduleEntity.getModuleName(), moduleEntity.getNoOfTopics(), moduleEntity.getNoOfSubTopics(),moduleEntity.getPrerequisites(),moduleEntity.getTargetAudience(),moduleEntity.getEstimatedTime(),moduleEntity.getInterpretation(),moduleEntity.getAgentNotes(),moduleEntity.getDifficultyLevel(),moduleEntity.getLastUpdateTime(),moduleEntity.getOrganization().getOrganisationId(),moduleEntity.getDeleted()));
        }
        return modules;
    }
}
